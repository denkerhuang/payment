...
function checkUserRole(req, targetUserRole, retriesLeft = 5, interval = 500) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield FsUtil.getData(LMCONST.Collection_User, req.uid, user => {
            ...
            if (req.uid === undefined) {
                if (retriesLeft) {
                    ...
                    yield firestore_util_1.sleep(interval);
...
function auth(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield adminValidate.auth().verifyIdToken(idToken)
...
function parseResponse(req, output) {
    return __awaiter(this, void 0, void 0, function* () {
        const h = Logger.orgLogHeader(req.logPath, 'parseResponse');
        let optionalArray;
        yield parseSwagger(LMCONST.SwaggerResponse, req, h, (optArray) => {
...
function parseSwagger(condition, req, h, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield SwaggerParser.parse(LMCONST.YamlFile)
            .then(api => {
