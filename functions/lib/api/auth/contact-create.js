...
class ContactCreateApi extends ApiAuthAlter {
    constructor(req, res) {
        super(req, res);
        this.name = 'ContactCreateApi';
    ...
    doAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield FsUtil.addDataPlusChecking(LMCONST.Collection_User, Input, (docId) => {
                this.output = { ContactId: docId };
                this.req.description = `create contact ${docId} success`;
            });
