...
class UserCreateApi extends ApiAuthAlter {
    constructor(req, res) {
        super(req, res);
        this.name = 'UserCreateApi';
    ...
    doAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield FsUtil.addDataPlusChecking(LMCONST.Collection_User, this.req.input, (docId) => {
