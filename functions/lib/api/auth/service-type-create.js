...
class ServiceTypeCreateApi extends ApiAuthAlter {
    constructor(req, res) {
        super(req, res);
        this.name = 'ServiceTypeCreateApi';
    ...
    doAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield FsUtil.addDataPlusChecking(LMCONST.Collection_ServiceType, this.req.input, (docId) => {
                this.output = { ServiceTypeId: docId };
            });
...
module.exports = ServiceTypeCreateApi;
//# sourceMappingURL=service-type-create.js.map